...
function _stringify(obj, options) {
  if ((typeof obj === 'undefined' ? 'undefined' : (0, (_typeof2 || _load_typeof()).default)(obj)) !== 'object') {
    throw new TypeError();
  }
  ...
  var keys = (0, (_keys || _load_keys()).default)(obj).sort(priorityThenAlphaSort);
  ...
  for (var i = 0; i < keys.length; i++) {
    ...
    } else if ((typeof val === 'undefined' ? 'undefined' : (0, (_typeof2 || _load_typeof()).default)(val)) === 'object') {
